...
class mts_related_posts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Display the related posts from current post\'s categories.','mythemeshop' ) )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo self::get_cat_posts( $qty, $comment_num, $date, $show_thumb6 );
		echo $after_widget;
	}

	public function get_cat_posts( $qty, $comment_num, $date, $show_thumb6 ) {
	global $post;
	$thePostID = $post->ID;
